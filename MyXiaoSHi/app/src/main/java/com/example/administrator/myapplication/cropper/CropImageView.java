...
package com.example.administrator.myapplication.cropper;
...
import com.example.administrator.myapplication.cropper.cropwindow.CropOverlayView;
import com.example.administrator.myapplication.cropper.cropwindow.edge.Edge;
import com.example.administrator.myapplication.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
	...
	public Bitmap getCroppedImage() {
		...
		try {
			...
			croppedBitmap = Bitmap.createBitmap(mBitmap, (int) actualCropX,
					(int) actualCropY, (int) actualCropWidth,
