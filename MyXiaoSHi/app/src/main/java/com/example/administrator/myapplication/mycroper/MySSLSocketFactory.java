 ...
 * @Desc: this class is used to create httpclient that bypasses ssl certificates
 * @author Shen fei
 * @date 2014-9-23上午10:38:37
 * 
 */
public class MySSLSocketFactory extends SSLSocketFactory {
	...
	/**
	 * @Desc: 得到一个SSL的HttpClient
	 * @author Shen fei
	 * @date 2014-9-23上午11:40:25
	 * @return
	 */
	public static DefaultHttpClient getNewHttpClient(int timeout) {
		try {
			...
			HttpConnectionParams.setConnectionTimeout(params, TimesConstant.REQUEST_TIMEOUT);
